...
public class FlightHandling {
    ...
    public static void main (String args[]) {
        // It is possible to change arrivalAirport: London -> true; Pekin -> null
        final String departureAirport = "Warsaw";
        String arrivalAirport = "Pekin";
        ...
        try {
            ...
            System.out.println("Result FlightHandling:" + "\n" +
                    "Connection between Warsaw nad destination Airport (" + arrivalAirport + ")");
        }
    }
}
